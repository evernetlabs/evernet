...
def ed25519_private_key_to_string(private_key: ed25519.Ed25519PrivateKey) -> str:
...
def ed25519_public_key_to_string(public_key: ed25519.Ed25519PublicKey) -> str:
...
def ed25519_string_to_private_key(private_key_str: str) -> ed25519.Ed25519PrivateKey:
...
def ed25519_string_to_public_key(public_key_str: str) -> ed25519.Ed25519PublicKey:
